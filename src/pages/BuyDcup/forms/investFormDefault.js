...
class InvestFormDefault extends Component {
    constructor(props) {
        super(props)
        this.state = {
            defaultTitle: 'BNB',
        ...
        return (
            <div id="form_invest">
                ...
                <div className="p_top">
                    ...
                    DCup
                    <div><span> 0 </span> / 9000000000</div>
                </div>
                <ProgressBar completed={0} customLabel=" " height='6px' baseBgColor='#1C2D3F' bgColor='#1FF493' />
                <div className="p_bottom">{0}% bought <span>6h left</span></div>
            </div>
...
export default InvestFormDefault;
